...
(function syncNotchBg(){
  ...
  const apply = ()=>{
    ...
    const corner = document.querySelector('.techNotchStage .techNotchCorner');
    if(corner){
      const bc = cs.borderLeftColor || cs.borderTopColor;
      corner.style.borderLeftColor = bc;
      corner.style.borderBottomColor = bc;
    }
