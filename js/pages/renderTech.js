    ...
    return `
      <div class="techRow pickRowFrame">
        <div class="techRowLeft">
          ...
          <button type="button" class="tbJump" data-cat="${safeSvcId(item.cat)}" style="background:transparent;border:none;padding:0;color:inherit;cursor:pointer;text-align:left;text-decoration:underline">${safe(item.label)}</button>
        </div>
