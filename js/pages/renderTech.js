...
<div class="overallMetric" style="font-size:34px;font-weight:1200;line-height:1;">${focusVal}</div>
        ...
        <div class="pills" style="margin-top:8px !important; display:flex; flex-wrap:wrap; gap:10px; align-items:center;">
          <div class="pill" style="padding:8px 12px; gap:6px; width:auto;">
            <div class="k" style="font-size:11px; color:var(--muted); font-weight:900; letter-spacing:.2px; text-transform:uppercase;">Avg ODO</div>
            <div class="v" style="font-size:18px; font-weight:1000; line-height:1;">${fmtInt(t.odo)}</div>
          </div>

          <div class="pill" style="padding:8px 12px; gap:6px; width:auto;">
            <div class="k" style="font-size:11px; color:var(--muted); font-weight:900; letter-spacing:.2px; text-transform:uppercase;">ROs</div>
            <div class="v" style="font-size:18px; font-weight:1000; line-height:1;">${fmtInt(t.ros)}</div>
          </div>

          <div class="pill" style="padding:8px 12px; gap:6px; width:auto;">
            <div class="k" style="font-size:11px; color:var(--muted); font-weight:900; letter-spacing:.2px; text-transform:uppercase;">ASRs</div>
            <div class="v" style="font-size:18px; font-weight:1000; line-height:1;">${fmtInt(t.summary?.[filterKey]?.asr)}</div>
          </div>

          <div class="pill" style="padding:8px 12px; gap:6px; width:auto;">
            <div class="k" style="font-size:11px; color:var(--muted); font-weight:900; letter-spacing:.2px; text-transform:uppercase;">Sold</div>
            <div class="v" style="font-size:18px; font-weight:1000; line-height:1;">${fmtInt(t.summary?.[filterKey]?.sold)}<span style="font-size:18px;font-weight:1000;color:#fff;margin-left:8px;white-space:nowrap">${__soldOfAsrTxt}</span></div>
          </div>
        </div>
