...
return `
  ...
  const headerWrapStyle = `<style>
body.route-tech .techHeaderWrap.techHeaderWrap15{
  grid-template-columns: 1.0625fr 2.0125fr !important; /* header -15%, diag +15% (from 1.25/1.75) */
}
@media (max-width: 980px){
  body.route-tech .techHeaderWrap.techHeaderWrap15{ grid-template-columns: 1fr !important; }
}
</style>`;
  const headerWrap = `${headerWrapStyle}<div class="techHeaderWrap techHeaderWrap15">${header}${top3Panel}</div>`;
