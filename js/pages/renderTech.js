...
${rankBadgeHtml(overall.rank ?? "—", overall.total ?? "—", focus, "lg")}
        ...
        <div class="pills" style="margin-top:8px !important; display:grid; grid-template-columns:repeat(3, max-content); gap:12px 14px; align-items:start;">
          <div class="pill" style="grid-column:1 / span 3; padding:12px 18px; gap:12px; width:fit-content; justify-self:start;">
            <div class="k" style="font-size:16px; color:rgba(234,240,255,.75); font-weight:900; letter-spacing:.2px; text-transform:none;">Avg Odo</div>
          ...
          <div class="pill" style="padding:12px 18px; gap:12px;">
            <div class="k" style="font-size:16px; color:rgba(234,240,255,.75); font-weight:900; letter-spacing:.2px; text-transform:none;">ROs</div>
            <div class="v" style="font-size:24px; font-weight:1000; line-height:1;">${fmtInt(t.ros)}</div>
          </div>

          <div class="pill" style="padding:12px 18px; gap:12px;">
            <div class="k" style="font-size:16px; color:rgba(234,240,255,.75); font-weight:900; letter-spacing:.2px; text-transform:none;">ASRs</div>
            <div class="v" style="font-size:24px; font-weight:1000; line-height:1;">${fmtInt(t.summary?.[filterKey]?.asr)}</div>
          </div>

          <div class="pill" style="padding:12px 18px; gap:12px;">
            <div class="k" style="font-size:16px; color:rgba(234,240,255,.75); font-weight:900; letter-spacing:.2px; text-transform:none;">Sold</div>
          ...
          <div class="titleRow">
            ...
            <div class="secHdrRight">${miniHtml}<div class="secFocusDial">${dialFocus}</div><div class="secHdrRank" style="margin:0 12px">${rankBadgeHtml(secRank && secRank.rank ? secRank.rank : "—", secRank && secRank.total ? secRank.total : "—", focus, "dial")}</div><div class="secHdrStats" style="text-align:right;display:flex;flex-direction:column;align-items:flex-end">
                <div class="secStatBlock">
                  <div class="secStatVal" style="font-size:36px;font-weight:1000;line-height:1;color:var(--text)">${topStatVal}</div>
                ...
                <div class="secStatBlock" style="margin-top:10px">
                  <div class="secStatVal" style="font-size:28px;font-weight:1000;line-height:1;color:var(--text)">${botStatVal}</div>
