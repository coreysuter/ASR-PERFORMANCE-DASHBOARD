...
const miniHtml = `<div class="secMiniDials" style="gap:8px;column-gap:8px;row-gap:8px">${minisOrdered.join("")}</div>`;
      ...
      <div class="panel">
        <div class="phead">
          <div class="titleRow">
            ...
            <div class="secHdrRight secHdrRightTight" style="gap:8px;column-gap:8px;row-gap:8px">${miniHtml}<div class="secFocusDial" style="margin:0;padding:0">${dialFocus}</div><div class="secHdrRank" style="margin:0;padding:0">${rankBadgeHtml(secRank && secRank.rank ? secRank.rank : "—", secRank && secRank.total ? secRank.total : "—", focus, "dial")}</div><div class="secHdrStats" style="text-align:right;display:flex;flex-direction:column;align-items:flex-end">
