...
const header = `
    <div class="panel techHeaderPanel">
      <div class="phead">
        <div class="titleRow techTitleRow" style="display:flex;align-items:flex-start;justify-content:space-between;gap:16px;">
          <div class="techLeftCluster" style="display:flex;align-items:flex-start;gap:14px;min-width:0;">
            <div class="techTitleLeft">
              <label for="menuToggle" class="hamburgerMini" aria-label="Menu">☰</label>
            </div>
            <div class="techNameWrap" style="min-width:0;">
              <div class="h2 techH2Big">${__nameHtml}</div>
              <div class="techTeamLine">${safe(team)}</div>
            </div>
          </div>

          <div class="techRightCluster" style="display:flex;flex-direction:column;align-items:flex-end;gap:10px;flex:0 0 auto;">
            <div class="techRankCorner" style="position:relative;">
        ...
        <div class="pills" style="margin-top:10px !important; display:grid; grid-template-columns: 1fr 340px; gap:12px 14px; align-items:start;">
          <div class="pill" style="grid-column:1; padding:12px 18px; gap:12px;">
          ...
          <div class="pill" style="grid-column:2; padding:12px 18px; gap:12px; justify-self:end; min-width:260px;">
