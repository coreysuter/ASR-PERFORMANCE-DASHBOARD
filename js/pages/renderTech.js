      ...
      <div class="phead">
        <div class="titleRow techTitleRow">
          ...
          <div class="techNameWrap">
            <div class="h2 techH2Big">${(()=>{const nm=String(t.name||"").trim();if(!nm) return "";const parts=nm.split(/\s+/);const first=parts.shift()||"";const last=parts.join(" ");return `<span style="display:block">${safe(first)}</span>` + (last?`<span style="display:block">${safe(last)}</span>`:"");})()}</div>
