...
function renderTech(techId){
  ...
  (function ensureTechDetailsSizingCSS(){
    ...
    st.textContent = `
      /* Tech Details only: adjust panel widths without touching other pages */
      body.route-tech .techHeaderWrap{
        /* base in app.css is 1.25fr 1.75fr; apply -15% / +15% */
        grid-template-columns: 1.0625fr 2.0125fr !important;
      }
      /* keep responsive stacking intact */
      @media (max-width: 980px){
        body.route-tech .techHeaderWrap{ grid-template-columns: 1fr !important; }
      }
`;
    document.head.appendChild(st);
