function renderServicesHome(){
  ...
  (function ensureServicesDashOverrides(){
    ...
    el.textContent = `
      ...
      /* Diag panel height trim (~30%) — target the same classes used by Tech Details diag section */
      .pageServicesDash .techPickPanel.diagSection{height:auto !important;}
      .pageServicesDash .techPickPanel.diagSection .diagBandRow{padding:8px !important;}
      .pageServicesDash .techPickPanel.diagSection .diagPieWrap{margin-top:7px !important;}
      .pageServicesDash .techPickPanel.diagSection .diagPieSvg{width:90px !important;height:90px !important;}
      .pageServicesDash .techPickPanel.diagSection .diagPieTxt{font-size:12px !important;}
      .pageServicesDash .techPickPanel.diagSection .pickMiniHdr{padding:7px 10px !important;}
      .pageServicesDash .techPickPanel.diagSection .pickList{padding:7px 10px !important;gap:6px !important;}
    `;
  })();
