function renderServicesHome(){
  ...
  (function ensureServicesDashOverrides(){
    ...
    el.textContent = `
      ...
      /* === Services Dash: MATCH Tech Details diagSection sizing === */
      .pageServicesDash .techPickPanel.diagSection{width:100% !important;}
      .pageServicesDash .techPickPanel.diagSection .phead{
        padding:12px !important;
        display:block !important;
        border-bottom:none !important;
      }
      .pageServicesDash .techPickPanel.diagSection .diagBandRow{padding:12px !important;}
      .pageServicesDash .techPickPanel.diagSection .pickRow{
      ...
      @media (max-width:980px){
        .pageServicesDash .techPickPanel.diagSection .pickRow{grid-template-columns:170px 1fr !important;}
      }
      @media (max-width:620px){
        .pageServicesDash .techPickPanel.diagSection .pickRow{grid-template-columns:1fr !important;}
      }
      .pageServicesDash .techPickPanel.diagSection .diagDivider{margin:0 12px !important;}
      ...
      .pageServicesDash .techPickPanel.diagSection .pickBox{
      ...
      .pageServicesDash .techPickPanel.diagSection .pickMiniHdr{
        font-size:13px !important;
        font-weight:1000 !important;
        letter-spacing:.25px !important;
      }
      .pageServicesDash .techPickPanel.diagSection .pickList{
      ...
      /* Pie chart sizing + interaction (match renderTech diagSection) */
      ...
      .pageServicesDash .techPickPanel.diagSection .diagPieSvg{
        width:142px !important;
        height:142px !important;
        display:block !important;
        overflow:visible !important;
      }
      .pageServicesDash .techPickPanel.diagSection .diagPieTxt{
        fill:#fff !important;
      ...
      .pageServicesDash .techPickPanel.diagSection .diagPieSlice{
        ...
        transition:filter 140ms ease, opacity 140ms ease, transform 140ms ease !important;
        opacity:.92 !important;
        transform-origin:50% 50% !important;
      }
      .pageServicesDash .techPickPanel.diagSection .diagPieSlice:hover{
        opacity:1 !important;
        filter:brightness(1.35) drop-shadow(0 6px 10px rgba(0,0,0,.35)) !important;
