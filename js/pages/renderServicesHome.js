          ...
          <div class="titleRow">
            <div>
              <div style="display:flex;align-items:center;gap:12px;flex-wrap:wrap">
                ...
                <div class="secBadgeRows">
                  <div class="secBadgeRow"><span class="secBadgeLbl">ASR</span>${triBadgeSvg("red", redReqCount)}${triBadgeSvg("yellow", yellowReqCount)}</div>
                  <div class="secBadgeRow"><span class="secBadgeLbl">SOLD</span>${triBadgeSvg("red", redCloseCount)}${triBadgeSvg("yellow", yellowCloseCount)}</div>
                </div>
              </div>
